	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="#"
				style="text-transform: uppercase; font-weight: 700">Librarian</a>
				...
				<div class="col-md-12">
					<div class="section_title text-center">
						<h2 style="font-size: 35px">
							<b>Redraft <%=User.getUser_name()%> Profile
							</b>
						</h2>
						...
						<p style="font-size: 15px">"Out of the mountain of despair, a
							stone of hope."</p>
							...
							<form action="./admin" method="post"
								...
								<div class="form-group">
									<button class="btn btn-primary btn-dark" type="submit"
										name="action" value="saveEditUser">Save</button>
								</div>
							</form>
							<%
							if (request.getAttribute("User") != null && (boolean) request.getAttribute("User")) {
							%>
							<script>
								Swal.fire('Success!', 
